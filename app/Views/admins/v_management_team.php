...
$templateSubJudul = "List Management Team";
?>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col lg-9 py-1 text-end">
                            <a href="<?php echo site_url('admins/management_team/tambah') ?>" class="btn btn-xl btn-primary">Tambah Team</a>
                        </div>
                    </div>
                    <?php
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($record as $value) {
                                $management_team_id = $value['management_team_id'];
                                $link_edit = site_url("admins/management_team/edit/$management_team_id");
                                $link_delete = site_url("admins/management_team/?aksi=hapus&management_team_id=$management_team_id");
                            ?>
                                <tr>
                                    <td><?php echo $nomor ?>.</td>
                                    <td><?php echo $value['management_team_name'] ?></td>
                                    <td><?php echo $value['management_team_job'] ?></td>
                                    <td>
