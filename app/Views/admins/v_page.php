                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col lg-9 py-1 text-end">
                            <a href="<?php echo site_url('admins/page/tambah') ?>" class="btn btn-xl btn-primary">Tambah Page</a>
                        </div>
                    </div>
                    <?php
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($record as $value) {
                                ...
                                $link_edit = site_url("admins/page/edit/$post_id");
                                $link_delete = site_url("admins/page/?aksi=hapus&post_id=$post_id");
                            ?>
                                <tr>
