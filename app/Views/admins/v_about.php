                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col lg-9 py-1 text-end">
                            ...
                            $dataAbout = mysqli_query($koneksi, "SELECT * FROM about");

                            $jumlahAbout = mysqli_num_rows($dataAbout);
                            ?>
                            <?php
                            if (!$jumlahAbout >= 1) {
                            ?>
                                <a href="<?php echo site_url('admins/about/tambah') ?>" class="btn btn-xl btn-primary">Tambah About</a>
                            <?php } ?>
                        </div>
                    </div>
                    <?php
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($record as $value) {
                                ...
                                $link_edit = site_url("admins/about/edit/$about_id");
                                $link_delete = site_url("admins/about/?aksi=hapus&about_id=$about_id");
                            ?>
                                <tr>
                                    <td><?php echo $nomor ?>.</td>
                                    <td><?php echo $value['about_description_title'] ?></td>
                                    <td><?php echo $value['about_description_desc'] ?></td>
                                    <td>
