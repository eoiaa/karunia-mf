...
$templateSubJudul = "List Achievement";
?>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col lg-9 py-1 text-end">
                            <a href="<?php echo site_url('admins/achievement/tambah') ?>" class="btn btn-xl btn-primary">Tambah Achievement</a>
                        </div>
                    </div>
                    <?php
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="col-6">Nama Penghargaan</th>
                        ...
                        <tbody>
                            ...
                            foreach ($record as $value) {
                                ...
                                $link_edit = site_url("admins/achievement/edit/$achievement_id");
                                $link_delete = site_url("admins/achievement/?aksi=hapus&achievement_id=$achievement_id");
                            ?>
                                <tr>
                                    <td><?php echo $nomor ?>.</td>
                                    <td><?php echo $value['achievement_title'] ?></td>
                                    <td><?php echo $value['achievement_category'] ?></td>
                                    <td>
