...
$templateSubJudul = "List Home Description";
?>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col lg-9 py-1 text-end">
                            <a href="<?php echo site_url('admins/home_description/tambah') ?>" class="btn btn-xl btn-primary">Tambah Home Description</a>
                        </div>
                    </div>
                    <?php
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($record as $value) {
                                $home_description_id = $value['home_description_id'];
                                $link_edit = site_url("admins/home_description/edit/$home_description_id");
                                $link_delete = site_url("admins/home_description/?aksi=hapus&home_description_id=$home_description_id");
                            ?>
                                <tr>
                                    <td><?php echo $nomor ?>.</td>
                                    <td><?php echo $value['home_description_title'] ?></td>
                                    <td><?php echo $value['home_description_desc'] ?></td>
                                    <td>
