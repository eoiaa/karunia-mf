    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            ?>
                ...
                ?>
                    <div class="carousel-item active" style="background-image: url(<?php echo base_url(LOKASI_UPLOAD . "/" . $post_thumbnail) ?>)">
                    <?php } ?>
                    <div class="carousel-container">
                        <div class="container">
                            <h2 class="animate__animated animate__fadeInDown"><?php echo (isset($value['post_title'])) ? $value['post_title'] : '' ?></h2>
                            <p class="animate__animated animate__fadeInUp"><?php echo (isset($value['post_description'])) ? $value['post_description'] : '' ?></p>
                    ...
                    <!-- Slide 2 -->
                    <div class="carousel-item" style="background-image: url(<?php echo base_url('user') ?>/assets/img/slide/slide-2.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item" style="background-image: url(<?php echo base_url('user') ?>/assets/img/slide/slide-3.jpg)">
                        <div class="carousel-container">
                            <div class="container">
